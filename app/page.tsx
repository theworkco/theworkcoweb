...
const fallbackProjects: Project[] = [
  ...
  {number: '04', title: 'MileUno — A learner-driver companion that turns required hours into measurable experience and practical coaching', tag: 'Product Strategy · UX · Prototype', href: 'https://mileuno.vercel.app', tone: 'ink', size: 'standard', imageUrl: '/images/mileuno-showcase.png'},
  {number: '05', title: 'BDGA — A secure convenience store for API keys, access tokens, credentials, and other project secrets', tag: 'Product Development · Brand · UX', href: 'https://www.bdga.ai', tone: 'paper', size: 'wide', browser: {front: '/images/bdga-showcase.png', back: '/images/bdga-showcase.png', label: 'bdga.ai', alt: 'BDGA secure project secrets store', cropChrome: true}},
